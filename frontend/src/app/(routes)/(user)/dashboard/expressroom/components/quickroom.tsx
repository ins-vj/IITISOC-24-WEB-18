...
<div className=" flex gap-[5px]">
      ...
      <div className="flex items-center justify-between ">
        ...
        <div className=" absolute -z-10 flex items-center justify-center h-[calc(100%-6px)] bg-customorange-600 rounded-lg w-[calc(50%-5px)] transition-left duration-200" style={{left : isPrivate ? "3px" : "107.5px"}}>
        ...
        <Tooltip offset={30} content="In Public rooms, users cannot freely share any video or audio" placement="bottom-end" className="text-white w-[300px]" color="warning">
