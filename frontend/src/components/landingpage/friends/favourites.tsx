...
export default function joinroom(props:any) {
    ...
    return (
        ...
        <Cards>
                ...
                <div className="w-full max-h-[35rem] min-h-[35rem] flex flex-col gap-1  border-small px-[5px] py-[2px] rounded-l-3xl border-default-200 dark:border-default-100  overflow-y-auto">
