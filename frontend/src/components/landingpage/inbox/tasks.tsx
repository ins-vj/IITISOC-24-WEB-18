...
export default function Tasks(props:any) {
  ...
  return (
    ...
    <div className=" relative flex w-[100%]  justify-start  hover:scale-[1.01] transition-all duration-300  items-center   backdrop-blur-md bg-[rgba(20,20,20,1)]   rounded-3xl">

      <Image src="/data/generative/searching.jpg"  width={1000} height={1000} alt="cool" className=" h-[100%] w-[25%] object-cover rounded-l-3xl hidden sm:flex" />

      <div className=" relative flex w-[100%]  justify-start   flex-col items-center   backdrop-blur-md bg-[rgba(20,20,20,1)] gap-[20px] p-[20px]  rounded-3xl ">
      {/* <WordPullUp
